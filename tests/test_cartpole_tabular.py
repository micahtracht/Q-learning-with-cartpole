...
from CartPoleTabular import clip_obs, moving_average, bin_counts, Q, env
...
def test_Q_shape_matches_bins_and_actions():
    """
    Q should have shape = bin_counts + [n_actions].
    """
    expected_shape = tuple(bin_counts + [env.action_space.n])
